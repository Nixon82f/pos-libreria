...
export function ProductList({
  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-stone-200 bg-white shadow-sm overflow-hidden">
      ...
      {/* Tab 1: Physical Products */}
      <div className={mainTab === "productos" ? "flex flex-1 flex-col overflow-hidden" : "hidden"}>
        {/* Header & Search */}
      ...
      {/* Tab 2: Quick Services (Persistent in DOM for 0ms tab switching) */}
